  ...
  return (
    <AboutClient>
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 ">
        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {Object.entries(SKILLS).map(([category, items], idx) => (
              <div
                key={category}
                className={`relative group p-1 rounded-[2.5rem] bg-gradient-to-br transition-all duration-700 hover:scale-[1.02] shadow-xl ${idx === 0 ? "from-purple-500/20 to-blue-500/20" :
        ...
        {/* GitHub Heatmap */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-16 sm:mt-24 pb-20">
          <GitHubHeatmap />
        </div>
